...
Apple AppDev Workflow is provided as a local plugin bundle for development workflows.
...
This plugin is provided on an "as is" basis, without warranties of correctness, availability, or fitness for a particular purpose.
